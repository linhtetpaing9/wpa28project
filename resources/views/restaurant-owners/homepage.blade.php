...
<head>
	...
	<!-- Bootstrap -->
	<link type="text/css" rel="stylesheet" href="{{asset('css/restaurant-owner-homepage.css')}}" />
...
<body>
	...
	<!-- jQuery Plugins -->
	<script type="text/javascript" src="{{asset('js/restaurant-owner-homepage.js')}}"></script>
